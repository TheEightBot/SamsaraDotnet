...
public interface IFunctionsClient
{
    ...
    Task<object> GetLogsAsync(string name, CancellationToken cancellationToken = default);

    // Functions storage
    Task<object> ListStorageFilesAsync(CancellationToken cancellationToken = default);
    Task<object> GetStorageFileAsync(string path, CancellationToken cancellationToken = default);
    Task<object> CreateStorageFileAsync(object request, CancellationToken cancellationToken = default);
    Task<object> UpdateStorageFileAsync(object request, CancellationToken cancellationToken = default);
    Task DeleteStorageFileAsync(string path, CancellationToken cancellationToken = default);
}
...
internal sealed class FunctionsClient : SamsaraServiceClientBase, IFunctionsClient
{
    ...
    public Task<object> GetLogsAsync(string name, CancellationToken cancellationToken = default)
        => HttpClient.GetAsync<object>($"functions/{Uri.EscapeDataString(name)}/logs", cancellationToken);

    public Task<object> ListStorageFilesAsync(CancellationToken cancellationToken = default)
        => HttpClient.GetAsync<object>("functions-storage/ls", cancellationToken);

    public Task<object> GetStorageFileAsync(string path, CancellationToken cancellationToken = default)
        => HttpClient.GetAsync<object>(QueryBuilder.WithParams("functions-storage/files", ("path", path)), cancellationToken);
    ...
    public Task<object> UpdateStorageFileAsync(object request, CancellationToken cancellationToken = default)
        => HttpClient.PutDataAsync<object>("functions-storage/files", request, cancellationToken);

    public Task DeleteStorageFileAsync(string path, CancellationToken cancellationToken = default)
        => HttpClient.DeleteAsync(QueryBuilder.WithParams("functions-storage/files", ("path", path)), cancellationToken);
}
