...
using Samsara.Sdk.Models.Legacy;
...
public interface ILegacyApisClient
{
    ...
    /// </summary>
    IAsyncEnumerable<V1DefectRecord> GetDvirDefectsHistoryAsync(
    ...
    IAsyncEnumerable<LegacyDriverVehicleAssignments> GetDriversVehicleAssignmentsAsync(
    ...
    /// nullable for backward compatibility with existing callers.
    /// </summary>
    IAsyncEnumerable<V1MaintenanceDvir> GetDvirHistoryAsync(
        DateTimeOffset? startTime = null,
        DateTimeOffset? endTime = null,
    ...
    /// </summary>
    IAsyncEnumerable<LegacyIdlingReportEvent> GetVehicleIdlingReportAsync(
    ...
    /// nullable for backward compatibility with existing callers.
    /// </summary>
    IAsyncEnumerable<V1SafetyEvent> GetSafetyEventsAsync(
        DateTimeOffset? startTime = null,
        DateTimeOffset? endTime = null,
        IReadOnlyList<string>? tagIds = null,
        IReadOnlyList<string>? parentTagIds = null,
    ...
    IAsyncEnumerable<LegacySafetyEventActivity> GetSafetyEventsAuditFeedAsync(DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, CancellationToken cancellationToken = default);

    /// <summary>Vehicle→driver assignments (<c>GET /fleet/vehicles/driver-assignments</c>).</summary>
    IAsyncEnumerable<LegacyVehicleDriverAssignments> GetVehiclesDriverAssignmentsAsync(
        DateTimeOffset? startTime = null,
        DateTimeOffset? endTime = null,
        string? vehicleIds = null,
        string? tagIds = null,
    ...
    /// </summary>
    Task<V1VehicleHarshEvent> V1GetVehicleHarshEventAsync(string vehicleId, long timestamp, CancellationToken cancellationToken = default);
}
...
internal sealed class LegacyApisClient : SamsaraServiceClientBase, ILegacyApisClient
{
    ...
    public IAsyncEnumerable<V1DefectRecord> GetDvirDefectsHistoryAsync(
        DateTimeOffset? startTime = null,
        DateTimeOffset? endTime = null,
        bool? isResolved = null,
        CancellationToken cancellationToken = default)
        => PaginateAsync<V1DefectRecord>(
    ...
    public IAsyncEnumerable<LegacyDriverVehicleAssignments> GetDriversVehicleAssignmentsAsync(
        IReadOnlyList<string>? driverIds = null,
        DateTimeOffset? startTime = null,
        DateTimeOffset? endTime = null,
        string? tagIds = null,
        ...
        string? driverActivationStatus = null,
        CancellationToken cancellationToken = default)
        => PaginateAsync<LegacyDriverVehicleAssignments>(
            QueryBuilder.WithParams(
    ...
    public IAsyncEnumerable<V1MaintenanceDvir> GetDvirHistoryAsync(
        DateTimeOffset? startTime = null,
        DateTimeOffset? endTime = null,
        IReadOnlyList<string>? parentTagIds = null,
        IReadOnlyList<string>? tagIds = null,
        CancellationToken cancellationToken = default)
        => PaginateAsync<V1MaintenanceDvir>(
            QueryBuilder.WithParams(
    ...
    public IAsyncEnumerable<LegacyIdlingReportEvent> GetVehicleIdlingReportAsync(
        DateTimeOffset startTime,
        DateTimeOffset endTime,
        string? vehicleIds = null,
        string? tagIds = null,
        ...
        int? minIdlingDurationMinutes = null,
        CancellationToken cancellationToken = default)
        => PaginateAsync<LegacyIdlingReportEvent>(
            QueryBuilder.WithParams(
    ...
    public IAsyncEnumerable<V1SafetyEvent> GetSafetyEventsAsync(
        DateTimeOffset? startTime = null,
        DateTimeOffset? endTime = null,
        IReadOnlyList<string>? tagIds = null,
        IReadOnlyList<string>? parentTagIds = null,
    ...
    public IAsyncEnumerable<LegacySafetyEventActivity> GetSafetyEventsAuditFeedAsync(DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, CancellationToken cancellationToken = default)
        => PaginateAsync<LegacySafetyEventActivity>(QueryBuilder.WithTimeRange("fleet/safety-events/audit-logs/feed", startTime, endTime), cancellationToken: cancellationToken);

    public IAsyncEnumerable<LegacyVehicleDriverAssignments> GetVehiclesDriverAssignmentsAsync(
        DateTimeOffset? startTime = null,
        DateTimeOffset? endTime = null,
        string? vehicleIds = null,
        string? tagIds = null,
        string? parentTagIds = null,
        CancellationToken cancellationToken = default)
        => PaginateAsync<LegacyVehicleDriverAssignments>(
            QueryBuilder.WithParams(
    ...
    public Task<V1VehicleHarshEvent> V1GetVehicleHarshEventAsync(string vehicleId, long timestamp, CancellationToken cancellationToken = default)
        => HttpClient.GetAsync<V1VehicleHarshEvent>(
